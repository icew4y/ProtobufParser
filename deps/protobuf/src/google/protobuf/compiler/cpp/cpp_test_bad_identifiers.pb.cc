...
,
  "google/protobuf/compiler/cpp/cpp_test_bad_identifiers.proto", &assign_descriptors_table_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5fbad_5fidentifiers_2eproto, 1794,
};
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        do {
          ...
          ::google::protobuf::internal::StringPieceField* str = msg->add_data();
          str->Clear();
          object = str;
          if (size > end - ptr) goto len_delim_till_end;
          auto newend = ptr + size;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 3: {
        ...
        parser_till_end = ::google::protobuf::internal::StringParserUTF8Verify;
        ::std::string* str = msg->mutable_length();
        str->clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        auto newend = ptr + size;
      ...
      case 5: {
        ...
        do {
          ...
          parser_till_end = ::google::protobuf::internal::StringPieceParserUTF8Verify;
          ::google::protobuf::internal::StringPieceField* str = msg->add_new_element();
          str->Clear();
          object = str;
          if (size > end - ptr) goto len_delim_till_end;
          auto newend = ptr + size;
      ...
      case 18: {
        ...
        parser_till_end = ::google::protobuf::internal::StringParserUTF8Verify;
        ::std::string* str = msg->mutable_string();
        str->clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        auto newend = ptr + size;
      ...
      case 29: {
        ...
        parser_till_end = ::google::protobuf::internal::StringPieceParserUTF8Verify;
        ::google::protobuf::internal::StringPieceField* str = msg->mutable_some_string_piece();
        str->Clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        auto newend = ptr + size;
      ...
      case 35: {
        ...
        parser_till_end = ::google::protobuf::internal::StringParserUTF8Verify;
        ::std::string* str = msg->mutable_release_length();
        str->clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        auto newend = ptr + size;
...
::google::protobuf::uint8* TestConflictingSymbolNames::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000040u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        32, HasBitSetters::do_(this), deterministic, target);
  }
  ...
  if (cached_has_bits & 0x00000080u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        36, HasBitSetters::release_do(this), deterministic, target);
  }
