  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 24: {
        ...
        ptr = Varint::Parse32Inline(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::google::protobuf::internal::StringPieceParser;
      ...
      case 74: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::google::protobuf::internal::StringParser;
        ::std::string* str = msg->mutable_default_string();
        str->clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        str->append(ptr, size);
      ...
      case 75: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::google::protobuf::internal::StringParser;
        ::std::string* str = msg->mutable_default_bytes();
        str->clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        str->append(ptr, size);
      ...
      case 84: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::google::protobuf::internal::StringPieceParser;
        ::google::protobuf::internal::StringPieceField* str = msg->mutable_default_string_piece();
        str->Clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        auto newend = ptr + size;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 7: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::google::protobuf::internal::StringPieceParser;
        ::google::protobuf::internal::StringPieceField* str = msg->mutable_oneof_string_string_piece();
        str->Clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        auto newend = ptr + size;
      ...
      case 8: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::google::protobuf::internal::StringPieceParser;
        ::google::protobuf::internal::StringPieceField* str = msg->mutable_oneof_bytes_string_piece();
        str->Clear();
        object = str;
        if (size > end - ptr) goto len_delim_till_end;
        auto newend = ptr + size;
